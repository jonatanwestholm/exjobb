...
backblaze = {#"min_subgroup_length": 3, "max_subgroup_length": 6, "subgroup_length": 3, # general
			...
			"train_share": 0.5, "test_share": 0.7, # splitting
			"failure_horizon": 20, 
			...
			"ESN_size_out": 20, # ESN
			"ESN_burn_in": 60,"ESN_batch_train" : True,"ESN_tikhonov_const": 10,  # ESN training
			"ESN_mixing": [("DIRECT","EXPDELAY",13,False,0.001),("EXPDELAY","RODAN",200,True,500),("EXPDELAY","TRIGGER",100),("RODAN","TRIGGER",100),
							("RODAN","RODAN",200,True,0.5),("TRIGGER","RODAN",200)],
			...
			"ESN_classifier": "MLP" #, "ESN_sig_limit": 1.1
			}
...
eye = {"train_share": 0.7, "test_share": 0.3, "self_test": False,# splitting
	   #"train_share": 0.4, "test_share": 0.6, "self_test": False,# splitting
	   		"num_timepoints": 200,
			"pos_w": 1, # classification and regression
			"ESN_spec": [("RODAN", {"N": 500,"v":0,"r":0.7}),
			...
			"ESN_mixing": [("DIRECT","EXPDELAY",14,False,0.001),("EXPDELAY","RODAN",200,True,100),("RODAN","EXPDELAY",0),("EXPDELAY","RODAN",0),("RODAN","RODAN",200)],
			#"ESN_rebuild_types": ["THRES","TRIGGER"], "ESN_rebuild_iterations": 1, "ESN_impact_limit": 1e-2,
			"ESN_feature_selection": "SVD_SEP",
...
esn_sim = {#"train_share": 0.4, "test_share": 0.4, "self_test": True,# splitting
			...
			"ESN_mixing": [("DIRECT","EXPDELAY",1,True,0.001),("RODAN","RODAN",0,False),("RODAN","EXPDELAY",0,False,1000),("EXPDELAY","RODAN",6,False,1000)],
			#"ESN_rebuild_types": ["THRES","TRIGGER"], "ESN_rebuild_iterations": 1, "ESN_impact_limit": 1e-2,
			"ESN_feature_selection": "SVD",
			"ESN_classifier": "LINEAR" #, "ESN_sig_limit": 0.1,
			}
